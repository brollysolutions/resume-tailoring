...
- Frontend: http://localhost:3004/resume_generator
- Backend API: https://brollysolutions.in/resume_generator/api
- API docs: https://brollysolutions.in/resume_generator/api/docs
...
| `NEXT_PUBLIC_API_URL` | Yes | `https://brollysolutions.in/resume_generator` | **Baked into frontend build** |
